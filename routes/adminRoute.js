...
// admin_route.post('/create-product-offer', auth.isLogin, offerController.createProductOffer);

// admin_route.post('/update-product-offer/:offerId', auth.isLogin, offerController.updateProductOffer);

// admin_route.get('/delete-product-offer/:offerId', auth.isLogin, offerController.deleteProductOffer);

// // Category Offers
// admin_route.post('/create-category-offer', auth.isLogin, offerController.createCategoryOffer);
// admin_route.post('/update-category-offer/:offerId', auth.isLogin, offerController.updateCategoryOffer);
// admin_route.get('/delete-category-offer/:offerId', auth.isLogin, offerController.deleteCategoryOffer);

// // Referral Offers
// admin_route.post('/create-referral-offer', auth.isLogin, offerController.createReferralOffer);
// admin_route.post('/update-referral-offer/:offerId', auth.isLogin, offerController.updateReferralOffer);
// admin_route.get('/delete-referral-offer/:offerId',auth.isLogin, offerController.deleteReferralOffer);
...
admin_route.get('/add-banner', auth.isLogin, bannerController.addBannerLoad);

admin_route.post('/add-banner',auth.isLogin, bannerController.addBanner);
...
admin_route.get('/location', auth.isLogin, locationController.loadLocation)

admin_route.get('/add-location', auth.isLogin, locationController.addLocationLoad)

admin_route.post('/add-location',auth.isLogin, locationController.addLocation)

admin_route.get('/edit-location', auth.isLogin, locationController.editLocationLoad)

admin_route.post('/edit-location',auth.isLogin, locationController.editLocation)
